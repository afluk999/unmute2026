...
export default function AdminPage() {
  ...
  if (!loggedIn) {
    return (
      <main className="min-h-screen bg-[#f6f3ee] px-5 py-6 text-[#111111] md:px-14">
        <section className="mx-auto max-w-xl">
          ...
          <div className="rounded-[42px] bg-[#f6f3ee] p-6 shadow-[14px_14px_30px_#d8d3cc,-14px_-14px_30px_#ffffff] md:p-10">
      ...
      <section className="mx-auto max-w-6xl">
        ...
        <div className="rounded-[42px] bg-[#f6f3ee] p-6 shadow-[14px_14px_30px_#d8d3cc,-14px_-14px_30px_#ffffff] md:p-10">
          ...
          <p className="mt-4 max-w-2xl text-sm font-medium leading-7 text-[#666] md:text-base">
            ...
            downloads. You can also view and delete uploaded items here.
          </p>
        ...
        <div className="mt-10 rounded-[42px] bg-[#f6f3ee] p-6 shadow-[14px_14px_30px_#d8d3cc,-14px_-14px_30px_#ffffff] md:p-10">
          <div className="mb-7 flex flex-col justify-between gap-4 md:flex-row md:items-center">
            <div>
              ...
              <p className="mt-2 text-sm font-bold text-[#777]">
                View and delete current {type} items.
              </p>
            </div>
  ...
  return (
    <div className="overflow-hidden rounded-[30px] bg-[#f6f3ee] p-5 shadow-[8px_8px_18px_#d8d3cc,-8px_-8px_18px_#ffffff]">
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <button
          onClick={onDelete}
          className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-[#e81818] text-white shadow-[6px_6px_14px_#d5b8b8,-6px_-6px_14px_#ffffff]"
        >
